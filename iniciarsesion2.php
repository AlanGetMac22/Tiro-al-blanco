...
<body>
    <!-- Formulario -->
    <form class="box" action="registro2.html" method="post">
        ...
        <!-- Botón de ingreso -->
        <p id="button">
            <input type="submit" name="bottom" value="Ingresar" onclick="getLocation()">
        </p>
    ...
    <script>
        ...
        var tab = document.getElementById("title").innerHTML = "Iniciar sesion | Tiro al blanco";
        ...
        var restaurar = document.getElementById("small").innerHTML = "Olvidaste tu contrasena?";
        var registro = document.getElementById("pa").innerHTML = "Registrarse";

        console.log("Preguntas principales");
